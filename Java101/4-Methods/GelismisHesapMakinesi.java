...
public class GelismisHesapMakinesi {
    ...
    static void mod(){
        ...
        int modValue = scan.nextInt();
        System.out.println("Sonuç : " + value%modValue);
    }
    static void rectangle(){
        ...
        System.out.println("Diktortgen Alanı : " + height * weight +"\nDiktortgen çevre uzunluğu : " + 2*(weight+ height));
    }
